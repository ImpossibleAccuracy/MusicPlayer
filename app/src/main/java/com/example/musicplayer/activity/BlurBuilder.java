...
public final class BlurBuilder {
    ...
    public static Bitmap blur(Bitmap image) {
        ...
        int hm = h - 1;
        int wh = w * h;
        int div = BLUR_RADIUS + BLUR_RADIUS + 1;
        ...
        for (y = 0; y < h; y++) {
            ...
            for (x = 0; x < w; x++) {
                ...
                stackstart = stackpointer - BLUR_RADIUS + div;
                ...
                if (y == 0) {
                    vmin[x] = Math.min(x + BLUR_RADIUS + 1, wm);
                }
                p = pix[yw + vmin[x]];
